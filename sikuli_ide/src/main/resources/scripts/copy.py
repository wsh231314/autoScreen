...
class Parser:
    ...
    def __init__(self, raw, out = sys.stdout):
        ...
        list = string.split(self.raw, '\n')
        print list
        new_list = list[2 : -2]
        print new_list
        again_list = [ item[4:] for item in new_list]
        print again_list
        self.raw = string.join(new_list, '\n')
        print self.raw
...
srcs = []
srcs.append("C:/work/worksoft/eclipse/workspace/sikuli_ide/excelApl/scripts/script_57/script_57.sikuli")
#if len(sys.argv) > 1:
#   srcs += sys.argv[1:]
