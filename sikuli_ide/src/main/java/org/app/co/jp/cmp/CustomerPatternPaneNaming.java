...
public class CustomerPatternPaneNaming extends JPanel {
    ...
    public CustomerPatternPaneNaming(CustomerImageButton imgBtn, JLabel msgApplied) {
        super(new GridBagLayout());
        init(imgBtn, msgApplied);
    }

    private void init(CustomerImageButton imgBtn, JLabel msgApplied) {
        _imgBtn = imgBtn;
