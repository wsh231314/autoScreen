...
public class CustomerPatternWindow extends JFrame {

	private static final long serialVersionUID = 1L;
	private static final String me = "PatternWindow: ";
    private CustomerImageButton _imgBtn;
    ...
    public CustomerPatternWindow(CustomerImageButton imgBtn, boolean exact,
                         float similarity, int numMatches) {
        init(imgBtn, exact, similarity, numMatches);
    }

    private void init(CustomerImageButton imgBtn, boolean exact, float similarity, int numMatches) {
