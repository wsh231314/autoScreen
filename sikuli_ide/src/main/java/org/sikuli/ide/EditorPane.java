...
//			this.setText(String.format(Settings.TypeCommentDefault, getSikuliContentType()));
    ...
    public String saveFileWithDescription(String strDescription) throws IOException {
        if (_editingFile == null) {
            return createAsFile(Settings.isMac(), strDescription);
        } else {
            writeSrcFile();
            
            // save the description TODO
            ScriptUtils.updateScriptInfo(SikuliIDE.scriptId, strDescription);
    ...
    public String saveAsFile(boolean accessingAsFile) throws IOException {
    	...
    	File file = ScriptUtils.createScriptInfo("test");
    ...
    public String createAsFile(boolean accessingAsFile, String strDescription) throws IOException {
        //File file = new SikulixFileChooser(sikuliIDE, accessingAsFile).save();
    	File file = ScriptUtils.createScriptInfo(strDescription);
