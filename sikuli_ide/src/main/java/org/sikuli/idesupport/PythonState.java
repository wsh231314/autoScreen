...
public class PythonState {
     ...
     *
     * @param tabsize the number of whitespace columns that equals a single tab
     */
     ...
     * reset.
     *
     * @param newChunk a new chunk of text
     */
    public void update(String newChunk) {
        ...
        SCAN:
        while (nextSearchStart < unmatchedChunk.length()) {
     ...
     * @throws IllegalStateException if the last physical line is not complete
     */
     ...
     * @throws IllegalStateException if the first physical line in the last logical line is not
     *                               complete
     */
     ...
     * @throws IllegalStateException if no complete physical line or only one complete physical line
     ...
     * @throws IllegalStateException if no logical line or only one logical line has been seen by
     *                               this instance
     */
